...
parser.add_argument('-o', '--output', help='specify an output PDF filename. by default, the new PDF is placed in the working directory named using the old filename prefixed with "new_".')
...
else: filename = "new_" + path.basename(args.pdf)
